...
("sage-intro-sequence-a"
  (24 :offscreen "SAGE" "JAG HAR SPENDERAT MITT LIV SÖKANDE EFTER SVAREN 
SOM MIN FAR,")
  (156 :offscreen "SAGE" "OCH MIN FARFAR MISSLYCKADES ATT HITTA.")
  (255)
  (260 :offscreen "SAGE" "VILKA VAR PREKURSORS?")
  (324 :offscreen "SAGE" "VARFÖR SKAPADE DE DEM MÅNGA MONOLITERNA SOM
OMGER VÅR PLANET?")
  (451)
  (454 :offscreen "SAGE" "HUR TÄMDE DE ECO, VÄRLDENS LIVSENERGI?")
  (578)
  (581 :offscreen "SAGE" "VAD VAR DERAS SYFTE? OCH VARFÖR FÖRSVANN DE?")
  (708)
  (720 :offscreen "SAGE" "JAG HAR FRÅGAT VÄXTERNA, MEN DE MINNS INTE.")
  (818 :offscreen "SAGE" "VÄXTERNA HAR FRÅGAT STENARNA, MEN STENARNA
KOMMER INTE IHÅG.")
  (955 :offscreen "SAGE" "TILL OCH MED STENARNA KOMMER INTE IHÅG...")
  (1064)
  (1087 :offscreen "SAGE" "VARJE BEN I MIN KROPP SÄGER MIG ATT")
  (1197 :offscreen "SAGE" "PÅ AXLARNA AV EN UNG POJKE")
  (1297 :offscreen "SAGE" "OVETANDE OM HANS ÖDE, OINTREWSSERAD I
SÖKANDET EFTER SANNINGEN")
  (1444 :offscreen "SAGE" "OCH LYSSNAR INTE PÅ MIN VÄGLEDNING!")
  (1536)
  (1542 :offscreen "SAGE" "OCH VARFÖR SKULLE HAN VILJA LYSSNA PÅ GAMLA SAMOS
DEN VISE ANNARS?")
  (1677)
  (1683 :offscreen "SAGE" "JAG ÄR BARA MÄSTAREN AV GRÖN ECO, EN AV DE
VISASTE MÄNNEN PÅ PLANETEN!")
  (1872)
  (1955 :offscreen "SAGE" "SÅ DET VERKAE SOM ATT SVARET INTE BÖRJAR MED FÖRSIKTIG
EFTERFORSKNING")
  (2080 :offscreen "SAGE" "ELLER FÖRNUFTIGT TÄNKANDE.")
  (2141)
  (2145 :offscreen "SAGE" "NEJ! SOM MED MÅNGA AV ÖDET’S MYSTERIER")
  (2281 :offscreen "SAGE" "BÖRJAR DET MED BARA EN BIT AV
OLYDNAD.")
  (2440 "DAXTER" "HALLÅ! EH, JAK? GAMLA GRÖNA TOKSTOLLEN SA TILL OSS ATT INTE KOMMA
HIT!")
  )
